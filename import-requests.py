...
# python3 import-requests.py --start-folder /Volumes --device-filter D01692572940000295373 --max-depth 1
# python3 import-requests.py --start-folder /Volumes/Extreme\ Pro/Photos\ Library --device-filter D01692572940000295373 --max-depth 0
